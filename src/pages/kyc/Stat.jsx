...
const userData = [
  ...
  { id: 2, title: 'Unverified Users', image: Unverified, key: 'unverified_users' },
  { id: 3, title: 'Verified Users', image: Verified, key: 'verified_users' },
  ...
  useEffect(() => {
    const getStat = async () => {
      try {
        ...
        const response = await axios.get('https://api.baronsandqueens.com/api/admin/users-stat', {
          headers: {
